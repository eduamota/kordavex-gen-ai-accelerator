...
**Interaction Mode**: Discovery → Delivery (Part 1 = Discovery, Part 2 = Delivery) (see common/socratic-interaction.md)
...
## Step 17: Commit Unit to Git Repository
- [ ] Stage all files generated or modified for this unit (application code only, not aidlc-docs/)
- [ ] Commit with message: `feat(<unit-name>): implement <brief description>`
- [ ] Example: `feat(auth-service): implement user authentication and JWT token management`
- [ ] Verify commit succeeded and working tree is clean for this unit's files
- [ ] Log commit hash in audit.md
